...
product_17 = Product.create!(name: "Sanitary Silicon", price: 20, brand: "Geb", characteristics: "Color: white", user: mathieu, category: hardware, sub_category: sub_cat_12, EAN: "3283988931505", description: product_description_17)
...
Review.create(user: jerome, order_id: 3, rating: 5)
Review.create!(user: mathieu, order_id: 4, rating: 5)
Review.create!(user: jerome, order_id: 5, rating: 5)

Bookmark.create!(user: patricia, product: product_1)
Bookmark.create!(user: patricia, product: product_3)
