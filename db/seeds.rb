...
Product.create(name: "Nail box", price: 5.00, condition: "Average", quantity_left: "50", user_id: 3, category_id: 2, sub_category_id: 7)
...
Product.create(name: "Wood tile floor", price: 10.00, condition: "Good", quantity_left: "75", user_id: 3, category_id: 3, sub_category_id: 9)
Product.create(name: "Hammer", price: 5.00, condition: "Good", quantity_left: "100", user_id: 3, category_id: 4, sub_category_id: 11)
